...
# Filtrar por tramos horarios
entre_9_y_10_30 <- df_tickets %>% filter(hora_num >= 9, hora_num <= 10.5) %>% nrow()
entre_19_y_21_30 <- df_tickets %>% filter(hora_num >= 19, hora_num <= 21.5) %>% nrow()

cat("Tickets entre 9:00 y 10:30:", entre_9_y_10_30, "\n")
cat("Tickets entre 19:00 y 21:30:", entre_19_y_21_30, "\n")
...
ggplot(productos_queso_agrupado, aes(x = reorder(descripcion, cantidad_total), y = cantidad_total)) +
  ...
  labs(title = "Cantidad total de quesos por descripción",
